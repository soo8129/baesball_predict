# get data from statiz
# bs params must be checked 
# default opt=4, year=2021
...
def _oppo_var(name='터커', birth='1990-07-06', game_id='20200728LGSK02020', stadium='MH'):
    params = {'opt': '4', 'sopt': '0', 'name': name, 'birth': birth, 're': '0', 'da': '2', 'year': '2021'}
    ...
    # [home or away, stadium ba, home_away ba, oppo_team ba]
    return oppo_variables


# 상황별 - 날짜/시간 탭
def _time_var(date='2020-07-28', name='터커', birth='1990-07-06'):
    params = {'opt': '4', 'sopt': '0', 'name': name, 'birth': birth, 're': '0', 'da': '1', 'year': '2021'}
    response = requests.get(URL, params=params)
    html = response.text
